...
class Light {
 ...
 public:
  Light(glm::vec3 _postion, glm::vec3 _direction, glm::vec3 _angles,
...
// 当一个光源被设置为无限远时，它被称为平行光(Directional
// Light)，因为所有的光线都有着同一个方向；它会独立于光源的位置。
// 平行光跟光源的位置无关 与旋转角相关

class DirLight : public Light {
 private:
 public:
  DirLight(glm::vec3 _direction, glm::vec3 _angles, glm::vec3 _ambient,
           glm::vec3 _diffuse, glm::vec3 _specular)
      : Light(glm::vec3(1.0f, 1.0f, 1.0f), _direction, _angles, _ambient,
              _diffuse, _specular) {}
  DirLight() {}
...
class PointLight : public Light {
 ...
 public:
  PointLight(glm::vec3 _postion, glm::vec3 _ambient, glm::vec3 _diffuse,
             glm::vec3 _specular, float _constant, float _linear,
             float _quadratic)
      : Light(_postion, glm::vec3(1.0f, 1.0f, 1.0f),
              glm::vec3(1.0f, 1.0f, 1.0f), _ambient, _diffuse, _specular),
        constant(_constant),
        linear(_linear),
...
class LightSpot : public Light {
 ...
 public:
  LightSpot(glm::vec3 _postion, glm::vec3 _direction_, glm::vec3 _angles,
            glm::vec3 _ambient, glm::vec3 _diffuse, glm::vec3 _specular,
            float _cosPhyInner = glm::cos(glm::radians(12.5f)),
            float _cosPhyOuter = glm::cos(glm::radians(17.5f)))
      : Light(_postion, glm::vec3(1.0f, 1.0f, 1.0f), _angles, _ambient,
              _diffuse, _specular),
        cosPhyInner(_cosPhyInner),
        cosPhyOuter(_cosPhyOuter) {}
  LightSpot() {}
